...
@Tag(name = "Headquarter REST API", description = "Endpoints para la gestión de Headquarter")
public class HeadquarterRestAdapter {
         ...
         */
        @Operation(summary = "Obtener todas las sedes", description = "Este endpoint devuelve una lista de todas las sedes registradas en el sistema.")
        @GetMapping("/v1/api")
         ...
         */
        @Operation(summary = "Obtener una sede por ID", description = "Este endpoint devuelve la información de una sede específica identificada por su ID.")
        @GetMapping("/v1/api/{headquarterId}")
        public Object getHeadquarterById(
                        @Parameter(description = "ID de la sede a consultar", required = true) @PathVariable UUID headquarterId) {
         ...
         */
        @Operation(summary = "Crear una nueva sede", description = "Este endpoint permite crear una nueva sede en el sistema. "
                        +
                ...
                return ResponseEntity.status(HttpStatus.CREATED)
                                .body(headquarterRestMapper.toHeadquarterResponse(
                                                headquarterServicePort.save(
                                                                headquarterRestMapper.toHeadquarter(
         ...
         *
         * Este endpoint recibe el ID de la sede a actualizar y los nuevos datos en
         * formato JSON,
         * los valida y los transforma a una entidad de dominio para ser persistida.
         * Luego, convierte
         ...
         * @param headquarterUpdateRequest DTO de entrada con los nuevos datos de la
         *                                 sede
         * @return Información de la sede actualizada en formato de respuesta (DTO)
         */
        @Operation(summary = "Actualizar una sede existente", description = "Este endpoint permite actualizar la información de una sede existente. "
                        +
        ...
        public ResponseEntity<?> updateHeadquarter(
                        @Parameter(description = "ID de la sede a actualizar", required = true) @PathVariable UUID headquarterId,
         ...
         *
         * Este endpoint recibe el ID de la sede a eliminar y ejecuta la operación de
         * eliminación
         * en el servicio de dominio. Retorna una respuesta con estado HTTP 204 (NO
         * CONTENT) si la eliminación es exitosa.
         *
         * @param headquarterId ID de la sede a eliminar
         * @return ResponseEntity sin contenido (HTTP 204) si la eliminación es exitosa
         */
        @Operation(summary = "Eliminar una sede", description = "Este endpoint permite eliminar una sede del sistema. "
                        +
        ...
        public ResponseEntity<Void> deleteHeadquarter(
                        @Parameter(description = "ID de la sede a eliminar", required = true) @PathVariable UUID headquarterId) {
