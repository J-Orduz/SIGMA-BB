 ...
 * Convierte entre los DTOs de entrada y salida de la capa REST y el modelo de
 * dominio {@link Person}.
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE, unmappedTargetPolicy = ReportingPolicy.IGNORE, uses = {
                EmailPersonRestMapper.class,
                PhonePersonRestMapper.class
})
public interface PersonRestMapper {

        /**
         * Convierte un DTO de {@link PersonCreateRequest} a su modelo de dominio
         * correspondiente.
         *
         * @param request Datos de la persona recibidos desde la capa REST
         * @return Objeto de dominio {@link Person} listo para ser utilizado en la
         *         lógica de negocio
         */
        Person toPerson(PersonCreateRequest request);

        /**
         * Convierte un DTO de {@link PersonCreateRequest} a su modelo de caso de uso
         * correspondiente.
         *
         * @param personCreateRequest Datos de la persona recibidos desde la capa REST
         * @return Objeto de caso de uso {@link PersonCreateRequestUseCase} listo para
         *         ser utilizado en la lógica de negocio
         */
        PersonCreateRequestUseCase toPersonCreateRequestUseCase(PersonCreateRequest personCreateRequest);

        /**
         * Convierte un DTO de {@link PersonUpdateRequest} a su modelo de dominio
         * correspondiente.
         *
        ...
        /**
         * Convierte un modelo de dominio {@link Person} a su representación de
         * respuesta REST.
         *
        ...
        /**
         * Convierte una lista de modelos de dominio {@link Person} a una lista de
         * respuestas REST.
         *
