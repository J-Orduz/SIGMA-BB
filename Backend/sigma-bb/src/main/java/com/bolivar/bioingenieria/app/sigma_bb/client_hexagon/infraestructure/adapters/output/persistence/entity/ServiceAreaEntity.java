...
public class ServiceAreaEntity {
         ...
         * Se establece una relación uno a muchos con la entidad
         * {@link ClientEquipmentEntity}.
         * La eliminación en cascada asegura que al eliminar un área de servicio,
         * también se eliminen los equipos relacionados.
         */
        @OneToMany(mappedBy = "serviceArea", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
