...
@Tag(name = "EmailClient REST API", description = "Endpoints para la gestión de EmailClient")
public class EmailClientRestAdapter {
         ...
         *
         * Este endpoint recibe el identificador del cliente y los datos del correo
         * electrónico,
         ...
         *
         * Retorna un código de estado HTTP 200 (OK) si la operación fue exitosa, junto
         * con la información actualizada del cliente.
         *
         * @param idClient Identificador único del cliente al que se le va a agregar el
         *                 correo electrónico.
         ...
         */
        @Operation(summary = "Agregar correo electrónico a un cliente", description = "Este endpoint permite agregar una dirección de correo electrónico a un cliente existente en el sistema. "
                        +
        ...
        public ResponseEntity<ClientResponse> createEmailClient(
                        @Parameter(description = "Identificador único del cliente al que se le va a agregar el correo electrónico", required = true) @PathVariable("idClient") String idClient,
         ...
         *
         * Este endpoint recibe el identificador del cliente, el identificador del
         * correo electrónico a actualizar y los nuevos datos del correo electrónico,
         * los valida y los transforma a un modelo de dominio para actualizar la
         ...
         * con la información actualizada del cliente.
         *
         * @param idClient Identificador único del cliente al que se le va a actualizar
         ...
         * @return ResponseEntity con el cliente actualizado y estado HTTP 200 (OK).
         */
        @Operation(summary = "Actualizar correo electrónico de un cliente", description = "Este endpoint permite actualizar una dirección de correo electrónico asociada a un cliente existente en el sistema. "
                        +
        ...
        public ResponseEntity<ClientResponse> updateEmailClient(
                        @Parameter(description = "Identificador único del cliente al que se le va a actualizar el correo electrónico", required = true) @PathVariable("idClient") String idClient,
                        @Parameter(description = "Identificador único del correo electrónico a actualizar", required = true) @PathVariable("emailId") UUID emailId,
                        @Valid @RequestBody EmailClientCreateRequest request) {
                return ResponseEntity.ok(
                                clientRestMapper.toClientResponse(
         ...
         *
         * Este endpoint recibe el identificador del cliente y el identificador del
         * correo electrónico a eliminar,
         * los valida y realiza la eliminación de la asociación del correo al cliente.
         * Luego, retorna el cliente actualizado en formato de respuesta sin el correo
         * eliminado.
         *
         * Retorna un código de estado HTTP 200 (OK) si la operación fue exitosa, junto
         * con la información actualizada del cliente sin el correo eliminado.
         *
         * @param idClient Identificador único del cliente al que se le va a eliminar el
         *                 correo electrónico.
         * @param emailId  Identificador único del correo electrónico a eliminar.
         * @return ResponseEntity con el cliente actualizado sin el correo eliminado y
         *         estado HTTP 200 (OK).
         */
        @Operation(summary = "Eliminar correo electrónico de un cliente", description = "Este endpoint permite eliminar una dirección de correo electrónico asociada a un cliente existente en el sistema. "
                        +
        ...
        public ResponseEntity<ClientResponse> deleteEmailClient(
                        @Parameter(description = "Identificador único del cliente al que se le va a eliminar el correo electrónico", required = true) @PathVariable String idClient,
                        @Parameter(description = "Identificador único del correo electrónico a eliminar", required = true) @PathVariable UUID emailId) {
                return ResponseEntity.ok(
                                clientRestMapper.toClientResponse(
