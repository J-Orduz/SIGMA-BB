...
public class OpenApiConfig {
        ...
        public OpenAPI customOpenAPI() {
                return new OpenAPI()
                                .info(new Info()
                                                ...
                                                .contact(new Contact().name("Equipo Bioingeniería")
                                                                .email("devops@bolivar.com"))
         ...
         * Permite filtrar las rutas que se muestran en un grupo separado dentro de
         * Swagger UI.
         *
        ...
        /**
         * Grupo de documentación para los endpoints relacionados con ubicaciones
         * geográficas.
         * (países y ciudades).
         *
         ...
         * (marcas, fabricantes, modelos, tipos de equipo, equipos y verificaciones
         * técnicas).
         *
        ...
        /**
         * Grupo de documentación para los endpoints relacionados con los recursos de
         * los clientes.
         * Permite filtrar las rutas que se muestran en un grupo separado dentro de
         * Swagger UI.
         *
        ...
        public GroupedOpenApi clientEquipmentApi() {
                return GroupedOpenApi.builder()
                                ...
                                .pathsToMatch("/client-equipment/**") // Incluye todas las rutas bajo
                                                                      // /client-equipment/**
                                .build();
        }
}
