 ...
 *
 * Esta clase expone los endpoints HTTP relacionados con el recurso Client
 * Equipment,
...
@Tag(name = "Client Equipment REST API", description = "Endpoints para la gestión de Client Equipment")
public class ClientEquipmentRestAdapter {
         ...
         */
        @Operation(summary = "Obtener todos los equipos de clientes", description = "Este endpoint devuelve una lista de todos los equipos asociados a clientes registrados en el sistema.")
        @GetMapping("/v1/api")
         ...
         */
        @Operation(summary = "Obtener equipo de cliente por ID", description = "Este endpoint devuelve la información de un equipo asociado a un cliente específico, identificado por su ID único.")
        @GetMapping("/v1/api/{clientEquipmentId}")
        public Object getClientEquipmentById(
                        @Parameter(description = "ID del equipo del cliente a consultar", required = true) @PathVariable UUID clientEquipmentId) {
                return clientEquipmentRestMapper
                                .toClientEquipmentResponse(clientEquipmentServicePort.findByID(clientEquipmentId));
        }
         ...
         * y luego invoca el servicio de dominio para guardar el nuevo equipo.
         * Finalmente,
         * devuelve la información del equipo creado en formato de respuesta (DTO).
         *
         * @param clientEquipmentCreateRequest DTO de entrada con los datos del nuevo
         *                                     equipo de cliente
         * @return Información del equipo de cliente creado en formato de respuesta
         *         (DTO)
         */
        @Operation(summary = "Crear nuevo equipo de cliente", description = "Este endpoint permite crear un nuevo equipo asociado a un cliente. Recibe los datos del equipo en formato JSON y devuelve la información del equipo creado.")
        @PostMapping("/v1/api")
                ...
                return ResponseEntity.status(HttpStatus.CREATED)
                                .body(clientEquipmentRestMapper.toClientEquipmentResponse(
                                                clientEquipmentServicePort.save(
                                                                clientEquipmentRestMapper.toClientEquipment(
                                                                                clientEquipmentCreateRequest))));
        }

        /**
         * Actualiza la información de un equipo de cliente existente.
         * <p>
         * Este endpoint recibe el ID del equipo de cliente a actualizar y los nuevos
         * datos en formato JSON.
         * Luego, transforma los datos a un modelo de dominio, invoca el servicio de
         * dominio para realizar la actualización,
         * y finalmente devuelve la información del equipo actualizado en formato de
         * respuesta (DTO).
         *
         * @param clientEquipmentId            ID del equipo del cliente a actualizar
         * @param clientEquipmentUpdateRequest DTO de entrada con los nuevos datos del
         *                                     equipo de cliente
         * @return Información del equipo de cliente actualizado en formato de respuesta
         *         (DTO)
         */
        @Operation(summary = "Actualizar equipo de cliente", description = "Este endpoint permite actualizar la información de un equipo asociado a un cliente existente. Se requiere el ID del equipo a actualizar y los nuevos datos en formato JSON.")
        @PutMapping("/v1/api/{clientEquipmentId}")
        public ResponseEntity<?> updateClientEquipment(
                        @Parameter(description = "ID del equipo del cliente a actualizar", required = true) @PathVariable UUID clientEquipmentId,
                ...
                return ResponseEntity.ok(
                                clientEquipmentRestMapper.toClientEquipmentResponse(
                                                clientEquipmentServicePort.update(clientEquipmentId,
                                                                clientEquipmentRestMapper.toClientEquipment(
         ...
         * <p>
         * Este endpoint recibe el ID del equipo de cliente a eliminar, invoca el
         * servicio de dominio para realizar la eliminación,
         * y devuelve una respuesta sin contenido (204 No Content) si la operación fue
         * exitosa.
         *
         * @param clientEquipmentId ID del equipo del cliente a eliminar
         * @return Respuesta sin contenido (204 No Content) si la eliminación fue
         *         exitosa
         */
        @Operation(summary = "Eliminar equipo de cliente", description = "Este endpoint permite eliminar un equipo asociado a un cliente. Se requiere el ID del equipo a eliminar.")
        @DeleteMapping("/v1/api/{clientEquipmentId}")
        public ResponseEntity<Void> deleteClientEquipment(
                        @Parameter(description = "ID del equipo del cliente a eliminar", required = true) @PathVariable UUID clientEquipmentId) {
