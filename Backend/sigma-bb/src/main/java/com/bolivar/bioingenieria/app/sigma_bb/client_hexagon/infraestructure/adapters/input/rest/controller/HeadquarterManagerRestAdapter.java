...
@Tag(name = "Headquarter Manager REST API", description = "Endpoints para la gestión de sedes por parte del gerente de cliente")
public class HeadquarterManagerRestAdapter {
         ...
         *
         * Este endpoint recibe el identificador de la sede y los datos del gerente a
         * agregar,
         * los valida y los transforma a un modelo de dominio para asociarlo a la sede.
         * Luego, retorna la información actualizada de la sede con el nuevo gerente
         * asociado.
         *
         * Retorna un código de estado HTTP 200 (OK) si la operación fue exitosa, junto
         * con la información actualizada de la sede.
         *
         * @param idHeadquarter Identificador único de la sede a actualizar.
         * @param request       Datos del gerente a agregar.
         * @return ResponseEntity con la información actualizada de la sede y estado
         *         HTTP 200 (OK).
         */
        @Operation(summary = "Agregar un gerente a una sede", description = "Este endpoint permite agregar un gerente a una sede existente. "
                        +
        ...
        public ResponseEntity<HeadquarterResponse> createHeadquarterManager(
                        @Parameter(description = "Identificador único de la sede a actualizar", required = true) @PathVariable UUID idHeadquarter,
         ...
         *
         * Este endpoint recibe el identificador de la sede, el identificador del
         * gerente a actualizar y los nuevos datos del gerente,
         * los valida y los transforma a un modelo de dominio para actualizar la
         * asociación al gerente en la sede.
         * Luego, retorna la información actualizada de la sede con el gerente
         * modificado.
         *
         * Retorna un código de estado HTTP 200 (OK) si la operación fue exitosa, junto
         * con la información actualizada de la sede.
         ...
         *         HTTP 200 (OK).
         */
        @Operation(summary = "Actualizar el gerente de una sede", description = "Este endpoint permite actualizar el gerente de una sede existente. "
                        +
         ...
         *
         * Este endpoint recibe el identificador de la sede y el identificador del
         * gerente a eliminar,
         * y ejecuta la operación de eliminación en el servicio de dominio. Luego,
         * retorna la información actualizada de la sede sin el gerente asociado.
         *
         * Retorna un código de estado HTTP 200 (OK) si la operación fue exitosa, junto
         * con la información actualizada de la sede.
         *
         ...
         *         HTTP 200 (OK).
         */
        @Operation(summary = "Eliminar un gerente de una sede", description = "Este endpoint permite eliminar un gerente asociado a una sede existente. "
                        +
